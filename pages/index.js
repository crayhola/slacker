    ...
    <div className="flex flex-col h-screen p-8">
      ...
      <img
        ...
        <div className="sm:w-3/5 text-justify font-medium w-full">
          ...
          <p><span className="underline">Here’s what this means:</span> we’re going to pause the signup process while we're doing this work. But we’ll be back very soon! If you've signed up before this hiatus, don't worry. You will hear from us very soon.</p>
